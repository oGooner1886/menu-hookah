...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Menu item synced from iiko or seeded from JSON';
    displayName: 'Product';
    pluralName: 'products';
  ...
  attributes: {
    branch: Schema.Attribute.Enumeration<['gusto', 'aroma']> & Schema.Attribute.Required;
    category: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    descr: Schema.Attribute.Text;
    editions: Schema.Attribute.JSON;
    ...
    portion: Schema.Attribute.Integer;
    price: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    sauce: Schema.Attribute.JSON;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    uid: Schema.Attribute.Integer & Schema.Attribute.Required & Schema.Attribute.Unique;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
}

      ...
      <div className={style.modal__block}>
        <div className={style.modal__content}>
          ...
          <div className={style.modal__content_main}>
            ...
            <p>При посещении нашего заведения заказ кальяна обязателен.</p>
            <p>
            ...
            <p>Запрещается приносить и распивать свои алкогольные напитки</p>
            <p>
            ...
            <p>Стоимость основного кальяна - 850 рублей</p>
            <p>Стоимость дополнительного кальяна - 650 рублей</p>
            <p>Сервисный сбор в размере 4% от общей суммы чека.</p>
          </div>
        </div>
